    ...
    return (
      <div>
        <div className="container">
          ...
          <p className="text">
            Wir man in der Grafik oben sehen kann sind die Resultate alle
            ziemlich nahe anneinander. Jedoch ist ein grosser
            Wissensunterschieden zwischen den verschiedenen Möglichkeiten
            vorhanden. Bei HTML und Spring Boot mit HTML habe ich am meisten
            Vorkenntnisse. Bei React und Angular nicht so viel bis jetzt.
          </p>
          <p className="text">
            Weshalb habe ich mich nun für React entschieden?
          </p>
          <p className="text">
          ...
          <p className="text">
            ...
            Bilder mit Nutzungsrechten anzeigen, damit man weiss, welche man
            frei verwenden kann.
          </p>
          ...
          <p className="text">
            ...
            verwendet. Wegen der Beschränkung auf 256 Farben ist GIF das
            Bildformat mit der geringsten Speicherplatz-Belegung. GIF-Bilder
            haben kurze Ladezeiten. Für Fotos und Bilder mit vielen Nuancen ist
            dieses Format ungeeignet. GIF ist bestens geeignet für kleine
            grafische Elemente wie Diagramme, Clip Art oder Buttons. GIF-Bilder
            können mit transparentem Hintergrund gespeichert werden.
          </p>
          <h3 className="title">PNG</h3>
          <p className="text">
            Dieses Format ist nicht mit allen Anwendungen kompatibel. Allerdings
            bietet es die Möglichkeit, kleine Dateien bei bleibend hoher
            Qualität zu nutzen. So können z.B. Logos und kleine Bilder mit
            Tausenden von Farbschattierungen korrekt weiterverarbeitet werden.
            PNG-Bilder können mit transparentem Hintergrund gespeichert werden
            und werden im Internet meist für kleinere Bilder Icons verwendet.
          </p>
          <h3 className="title">JPEG</h3>
          <p className="text">
            Das Format für digitale Bilder unterstützt das volle Farbspektrum.
            Es ist das kompatibelste und universell nutzbarste Bildformat. Fast
            alle Anwendungen können JPEG öffnen und in JPEG konvertieren. Das
            Scannen und Einlesen von Fotos aus Digitalkameras geschieht häufig
            im JPEG-Format. Für Bildansichten mit geringer Auflösung im Internet
            (Beanspruchung von wenig Speicherplatz) ist es ideal. Bei
            Komprimierung kommt es zu Verlusten von Bildinformationen. JPEG ist,
            im Gegensatz zu vektorgraphischen Formaten (basierend auf Vektoren),
            ein pixelbasiertes Format (basierend auf Bildpunkte).
          </p>
